...
def forward_layers(
    ...
    *,
    ...
    Note:
        For decode inside a token generation loop, use the specialized decode path
        in GeneratorMixin._prefill_and_decode which pre-splits the layers to avoid
        XLA treating weights as loop-carried state.
    """
