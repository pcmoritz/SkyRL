...
// ptrs: [g_local] int64 buffer to hold device pointers
ffi::Error GroupedGemmBf16Impl(
    ...
    ffi::ResultBuffer<ffi::S64> A_ptrs_buf,  // mutable
    ffi::ResultBuffer<ffi::S64> B_ptrs_buf,
    ffi::ResultBuffer<ffi::S64> C_ptrs_buf,
...
ffi::Error GroupedGemmBf16TransImpl(
    ...
    ffi::Buffer<ffi::S32> group_sizes,
    ffi::Buffer<ffi::S32> group_offset_buf,
    ffi::ResultBuffer<ffi::S64> A_ptrs_buf,
    ffi::ResultBuffer<ffi::S64> B_ptrs_buf,
    ffi::ResultBuffer<ffi::S64> C_ptrs_buf,
